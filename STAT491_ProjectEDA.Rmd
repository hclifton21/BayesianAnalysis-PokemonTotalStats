---
title: "STAT 491 - Pokémon Project Code"
...
nrow(pokemon.dat)
summary(pokemon.dat$Type)

summary(pokemon.dat$Type2)

summary(pokemon.dat$Generation)

summary(pokemon.dat$Evolution)
aggregate(pokemon.dat$Total~pokemon.dat$Evolution, FUN=mean)

summary(pokemon.dat$Legendary)
```
